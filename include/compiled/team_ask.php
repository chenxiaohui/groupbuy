        ...
        <div class="hy_left" id="content">
			...
			<div class="hy_left_b">
				...
				<?php if(is_login()){?>
					...
					<div id="consult-add-succ" class="succ"><p style="padding:0px">您的问题已成功提交，客服MM很快就会回复的，稍等一会儿再来看吧。</p><p><a href="/team.php?id=<?php echo $team['id']; ?>">返回本团购</a>，或<a id="consult-add-more" href="javascript:void(0);">还有其他问题？</a></p></div>
				<?php } else { ?>
