...
<div class="hy_box">
        <div class="hy_left">
            <div class="hy_left_a">
            <ul>
            <li><a href="us.php">关于我们</a></li><li><a href="contact.php">联系我们</a></li><li class="hov">汇款账号</li><li><a href="promise.php">保障承诺</a></li>
            </ul>
            </div>
            <div class="hy_left_b">
                <div class="hy_left_b_a"><div class="l">汇款账号</div></div>
                <div class="p_a" style="margin-top:40px"></div>
                <div class="p_one">账号：24117542@qq.com</div>
                <div class="p_b"></div>
                ...
                <table height="114" cellspacing="1" cellpadding="0" border="0" width="600"  class="p_tab">
					  ...
					  <table height="110" cellspacing="1" cellpadding="0" border="0" width="600" class="p_tab">
						  ...
						  <tr>
						    <td bgcolor="#d2f0ff">中国工商银行</td>
						    <td bgcolor="#d2f0ff">海南三亚河西支行</td>
						    <td bgcolor="#d2f0ff">杨伟春</td>
						    <td bgcolor="#d2f0ff">6222   0222   0101   4555   017</td>
						    <td bgcolor="#d2f0ff">95588</td>
					      </tr>
						  <tr>
							<td bgcolor="#e5f1f4">中国农业银行</td>
							<td bgcolor="#e5f1f4">海南三亚农行营业部</td>
							<td bgcolor="#e5f1f4">杨伟春</td>
							<td bgcolor="#e5f1f4">6228   4801   5021   3634   911</td>
                ...
                <div class="p_d" style=" margin-top:30px"></div>
                    <div class="p_menshi_box">
                        <div class="p_menshi"><span>北京门市</span><p>地址：北京市东城区朝阳门内大街288号凯德华玺333室<br /><a href="contact.aspx#beijing" target="_blank">查看详细地址</a></p></div><div class="p_menshi"><span>南京门市</span> <p>地址：南京市白下区石鼓路107号华威大厦9楼A室<br /><a href="contact.aspx#nanjing" target="_blank">查看详细地址</a></p></div><div class="p_menshi"><span>上海门市</span><p>地址：上海市中山北路858号金甸大厦204室<br /><a href="contact.aspx#shanghai" target="_blank">查看详细地址</a></p></div>
                    </div>
            </div>
