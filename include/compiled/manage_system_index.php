            ...
            <div class="box-content">
                ...
                <div class="sect">
                    <form method="post">
						...
						<div class="field">
                            <label>人人主页</label>
                            <input type="text" size="30" name="system[renren]" class="f-input f-hint" value="<?php echo htmlspecialchars(stripslashes($INI['system']['renren'])); ?>"/>
						</div>
						<div class="field">
                            <label>开心主页</label>
                            <input type="text" size="30" name="system[kaixin]" class="f-input f-hint" value="<?php echo htmlspecialchars(stripslashes($INI['system']['kaixin'])); ?>"/>
						</div>
                        <div class="field">
						...
						<div class="field">
							<label>SEO关键字</label>
							<input type="text" size="30" name="system[seokeyword]" class="f-input f-hint" value="<?php echo htmlspecialchars(stripslashes($INI['system']['seokeyword'])); ?>" />
						</div>
						<div class="act">
