		...
		<div class="box clear">
            ...
            <div class="box-content">
                <div class="head">
					...
					<ul class="filter">
						<li><form action="/biz/coupon.php" method="get">项目：<input type="text" class="h-input" name="title" value="<?php echo htmlspecialchars($title); ?>" >&nbsp;<input type="submit" value="筛选" class="formbutton"  style="padding:1px 6px;"/>&nbsp;券编号：<input type="text" class="h-input" name="coupon" value="<?php echo htmlspecialchars($coupon); ?>" >&nbsp;<select name="state"><?php echo Utility::Option($option_state, $state, '--所有--'); ?></select><input type="submit" value="筛选" class="formbutton"  style="padding:1px 6px;"/><form></li>
					</ul>
				</div>
                <div class="sect">
