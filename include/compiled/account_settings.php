            ...
            <div class="hy_left_b">
                ...
                <div class="sect">
                    <form id="settings-form" method="post" action="/account/settings.php" enctype="multipart/form-data" class="validator">
						<div style="padding-left: 10px"><a href="/thirdpart/sina/bindsina.php">绑定新浪微博</a></div>
                        ...
                        <div class="field mobile">
                            <label>手机号码</label>
                            <input type="text" size="30" name="mobile" id="settings-mobile" class="number" value="<?php echo $login_user['mobile']; ?>" require="<?php echo option_yes('needmobile')?'true':'require'; ?>" datatype="mobile|ajax" url="<?php echo $WEB_ROOT; ?>/ajax/validator.php" vname="signupmobile"  msg="手机格式不对|手机号码已经被使用" <?php echo $login_user['mobilecode']=='yes'?'readonly':''; ?>/><span class="inputtip">手机号码是我们联系您最重要的方式，请准确填写</span>
                        </div>
						...
						<div class="field city">
                            <label>所在城市</label>
							<select name="city_id" class="f-city"><?php echo Utility::Option(getMainCities(), $login_user['city_id']); ?><option value='0'>其他</option></select>
                        </div>
