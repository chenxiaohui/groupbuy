...
<div id="coupons">
	<div class="dashboard" id="dashboard">
		<ul><?php echo mcurrent_order('timeout'); ?></ul>
	</div>
		...
		<div class="box clear">
            ...
            <div class="box-content">
                ...
                <div class="sect">
					...
					<tr><th width="40">ID</th><th width="390">项目</th><th width="180">用户</th><th width="40" nowrap>数量</th><th width="50" nowrap>总款</th><th width="50" nowrap>余付</th><th width="50" nowrap>应付</th><th width="50" nowrap>递送</th><th width="50" nowrap>操作</th></tr>
					...
					<tr <?php echo $index%2?'':'class="alt"'; ?> id="order-list-id-<?php echo $one['id']; ?>">
						...
						<td class="op" nowrap><a href="/ajax/manage.php?action=orderremove&id=<?php echo $one['id']; ?>" class="ajaxlink" ask="确定删除本订单？">删除</a></td>
					</tr>
					<?php }}?>
