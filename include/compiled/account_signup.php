                ...
                <div class="sect">
                    <form id="signup-user-form" method="post" action="/account/signup.php" class="validator">
                        ...
                        <div class="field password">
                            ...
                            <input type="password" size="30" name="password" id="signup-password" class="f-input" require="true" datatype="require"msg="请填写" />
					...
					<?php }?>
						<div class="field city">
							...
							<select name="city_id" class="f-city"><?php echo Utility::Option(getMainCities($allcities), $city['id']); ?><option value='1'>其他</option></select>
                        </div>
