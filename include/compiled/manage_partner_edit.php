	...
	<div id="content" class="clear mainwide">
        <div class="clear box">
            ...
            <div class="box-content">
                <div class="head"><h2>编辑商户</h2><b style="margin-left:20px;font-size:16px;">（<?php echo $partner['title']; ?>）</b></div>
                <div class="sect">
					...
					<input type="hidden" name="id" value="<?php echo $partner['id']; ?>" />
						...
						<div class="field">
							<label>商家图片</label>
							<input type="file" size="30" name="upload_image" id="team-create-image" class="f-input f-hint" />
							<?php if($partner['image']){?><span class="hint"><?php echo team_image($partner['image']); ?></span><?php }?>
						</div>
						<div class="field">
							<label>商家图片1</label>
							<input type="file" size="30" name="upload_image1" id="team-create-image1" class="f-input f-hint" />
					...
					<?php if($INI['system']['googlemap']){?>
                        <div class="field">
                            <label>地图坐标</label>
                            <input type="text" size="30" name="longlat" style="width:300px;cursor:point;" class="f-input f-hint" id="inputlonglat"  value="<?php echo $partner['longlat']; ?>" /><input type="button" onclick="X.misc.setgooglemap('<?php echo $partner['longlat']; ?>');"  value="进入地图"/><span class="inputtip"><a href="javascript:;" style="cursor:point;" onclick="jQuery('#inputlonglat').val('');">取消GogleMap坐标信息</a></span>
						</div>
					<?php }?>
						<div class="wholetip clear"><h3>3、基本信息</h3></div>
                        <div class="field">
                            <label>商户名称</label>
                            <input type="text" size="30" name="title" id="partner-create-title" class="f-input f-hint" value="<?php echo $partner['title']; ?>" datatype="require" require="true" />
                        </div>
                        <div class="field">
                            <label>网站地址</label>
