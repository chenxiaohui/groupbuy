...
<form method="post" action="/manage/category/edit.php" class="validator">
	...
	<table width="96%" class="coupons-table">
		...
		<tr><td nowrap><b>自定义分组：</b></td><td><input type="text" name="czone" value="<?php echo $category['czone']; ?>" class="f-input" /></td></tr>
		...
		<tr><td nowrap><b>二级分类(Y/N)：</b></td><td><input type="text" name="relate_data" value="<?php echo $category['relate_data']; ?>" class="f-input" style="text-transform:uppercase;"/></td></tr>
