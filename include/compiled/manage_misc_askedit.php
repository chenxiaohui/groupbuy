	...
	<div id="content" class="clear mainwide">
        <div class="clear box">
            ...
            <div class="box-content">
                <div class="head"><h2>答复</h2><span class="headtip"><?php echo $user['username']; ?>关于（<a href="/team.php?id=<?php echo $team['id']; ?>" target="_blank"><?php echo $team['title']; ?></a>）的咨询</span></div>
                <div class="sect">
