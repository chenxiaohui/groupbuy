        ...
        <div class="clear box">
            ...
            <div class="box-content">
                ...
                <div class="sect">
					...
					<!-- ipspay -->
						<div class="wholetip clear"><h3><?php echo ++$index; ?>、环讯借记卡支付（没有的话留空）</h3></div>
						<div class="field">
							<label>商户ID号</label>
							<input type="text" size="30" name="ipspay[mid]" class="f-input" value="<?php echo $INI['ipspay']['mid']; ?>" style="width:200px;"/>
                        </div>
                        <div class="field">
                            <label>交易密钥</label>
                            <textarea width="30" rows="5" name="ipspay[sec]" class="f-input" value=""><?php echo $INI['ipspay']['sec']; ?></textarea>
						</div>
					<!-- ipsPay/End -->	

					<!-- ipscardpay -->
						<div class="wholetip clear"><h3><?php echo ++$index; ?>、环讯信用卡支付（没有的话留空）</h3></div>
						<div class="field">
							<label>商户ID号</label>
							<input type="text" size="30" name="ipscardpay[mid]" class="f-input" value="<?php echo $INI['ipscardpay']['mid']; ?>" style="width:200px;"/>
                        </div>
                        <div class="field">
							<label>商户RSA公钥</label>
							<textarea width="30" rows="5" name="ipscardpay[rsasec]" class="f-input" value=""><?php echo $INI['ipscardpay']['rsasec']; ?></textarea>
                        </div>
                        <div class="field">
                            <label>交易密钥</label>
                            <textarea width="30" rows="5" name="ipscardpay[sec]" class="f-input" value=""/><?php echo $INI['ipscardpay']['sec']; ?></textarea>
						</div>
					<!-- ipscardPay/End -->		
