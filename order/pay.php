...
elseif ( $_POST['service'] == 'credit' ) {
	...
	if ( $order['origin'] > $login_user['money'] + $tmp_goldcoin  ){
	...
	Table::UpdateCache('order', $order_id, array(
				...
				'credit' => $order['origin']-$tmp_goldcoin,
				'pay_time' => time(),
				));
