...
/* magic_quota_gpc *///处理转义
$_GET = magic_gpc($_GET);//get
$_POST = magic_gpc($_POST);//Post
$_COOKIE = magic_gpc($_COOKIE);//cookie

/* process currefer*///当前URL去掉域名之后
...
//$hotcities = option_hotcategory('city', false, true);//热门分类改为手动确定
$allcities = getallcities();//所有城市
$city = cookie_city(null);//获取当前城市
//$group=cookie_group(null);//获取当前类别
